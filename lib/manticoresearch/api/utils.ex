...
defmodule Manticoresearch.Api.Utils do
  ...
  - body (String.t): A query parameter string. 
  ...
  """
  @spec sql(Tesla.Env.client, String.t, keyword()) :: {:ok, Manticoresearch.Model.ErrorResponse.t} | {:ok, list(Map.t)} | {:error, Tesla.Env.t}
